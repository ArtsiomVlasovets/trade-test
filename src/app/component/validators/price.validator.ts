...
export class CustomValidator {
  ...
  static validExitDate = (exitDateControl: AbstractControl): ValidatorFn => {
    return (entryDateControl: AbstractControl): { [key: string]: boolean } | null => {
console.log('exitDateControl', exitDateControl)
console.log('entryDateControl', entryDateControl)
